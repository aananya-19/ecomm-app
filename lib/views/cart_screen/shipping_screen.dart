  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: SizedBox(
        ...
        child: ourButton(
          onPress:(){
            if(controller.addressController.text.length>10 || controller.cityController.text.length>10 || controller.stateController.text.length>10 || controller.postalcodeController.text.length>10 || controller.phoneController.text.length>10){
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            customTextField(hint: "Phone", isPass: false, title: "Phone No.", controller: controller.phoneController),
          ],),
      )
    );
  }
